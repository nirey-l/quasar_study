<template>
    <q-page class="row items-center justify-between q-pa-xl">
        ...
        <div class="col-4 column content-center">
            ...
            <q-btn v-else class="q-mb-lg" label="size select" type="submit" color="black" />
...
const totalPrice = computed(() => price*quantity.value)
const isFreesize = ref(false)

// axios.get('getProduct?')

//computed(): 이미 ref로 선언된 값에 따라 또 바껴야 하는 변수
